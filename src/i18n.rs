...
const EN_ABOUT: About = About {
    ...
    build_log: "build log",
    releases_size: "A further **__RELEASES_SIZE__** of video is stored in GitHub Releases, which doesn't count toward the Pages limit.",
...
const RU_ABOUT: About = About {
    ...
    releases_size: "Ещё **__RELEASES_SIZE__** видео хранится в GitHub Releases и не учитывается в лимите Pages.",
...
const UK_ABOUT: About = About {
    ...
    releases_size: "Ще **__RELEASES_SIZE__** відео зберігається в GitHub Releases і не враховується в ліміті Pages.",
...
const BE_ABOUT: About = About {
    ...
    releases_size: "Яшчэ **__RELEASES_SIZE__** відэа захоўваецца ў GitHub Releases і не ўлічваецца ў ліміце Pages.",
...
const DE_ABOUT: About = About {
    ...
    build_log: "Build-Log",
    releases_size: "Weitere **__RELEASES_SIZE__** Video liegen in GitHub Releases und zählen nicht zum Pages-Limit.",
...
const FR_ABOUT: About = About {
    ...
    releases_size: "**__RELEASES_SIZE__** de vidéo supplémentaires sont stockés dans GitHub Releases et ne comptent pas dans la limite Pages.",
...
const ZH_ABOUT: About = About {
    ...
    last_updated: "最后更新",
    build_log: "构建日志",
    releases_size: "另有 **__RELEASES_SIZE__** 视频存储在 GitHub Releases 中，不计入 Pages 限额。",
    wd_property: "属性",
    wd_value: "值",
...
const JA_ABOUT: About = About {
    ...
    last_updated: "最終更新",
    build_log: "ビルドログ",
    releases_size: "さらに **__RELEASES_SIZE__** の動画が GitHub Releases に保存されており、Pages の上限には含まれません。",
    wd_property: "プロパティ",
    wd_value: "値",
...
const PL_ABOUT: About = About {
    ...
    releases_size: "Kolejne **__RELEASES_SIZE__** wideo jest przechowywane w GitHub Releases i nie liczy się do limitu Pages.",
...
const ES_ABOUT: About = About {
    ...
    releases_size: "Otros **__RELEASES_SIZE__** de vídeo se almacenan en GitHub Releases y no cuentan para el límite de Pages.",
...
const KO_ABOUT: About = About {
    ...
    build_log: "빌드 로그",
    releases_size: "추가로 **__RELEASES_SIZE__** 분량의 동영상이 GitHub Releases에 저장되며 Pages 한도에 포함되지 않습니다.",
    wd_property: "속성",
    wd_value: "값",
...
const KA_ABOUT: About = About {
    ...
    releases_size: "კიდევ **__RELEASES_SIZE__** ვიდეო ინახება GitHub Releases-ში და არ ითვლება Pages-ის ლიმიტში.",
    wd_property: "თვისება",
...
const HI_ABOUT: About = About {
    ...
    build_log: "बिल्ड लॉग",
    releases_size: "अतिरिक्त **__RELEASES_SIZE__** वीडियो GitHub Releases में संग्रहीत है, जो Pages सीमा में नहीं गिना जाता।",
    wd_property: "गुण",
    wd_value: "मान",
