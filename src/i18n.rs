...
pub struct About {
    ...
    /// Has `__RELEASES_SIZE__`; shown only when media is offloaded to Releases.
...
const EN_ABOUT: About = About {
    ...
    build_log: "build log",
    releases_size: "In GitHub Releases: **__RELEASES_SIZE__** of media files — outside git, so it doesn't count toward the limit.",
...
const RU_ABOUT: About = About {
    ...
    releases_size: "В GitHub Releases: **__RELEASES_SIZE__** медиафайлов — вне git, поэтому не учитывается в лимите.",
...
const UK_ABOUT: About = About {
    ...
    releases_size: "У GitHub Releases: **__RELEASES_SIZE__** медіафайлів — поза git, тому не враховується в ліміті.",
...
const BE_ABOUT: About = About {
    ...
    releases_size: "У GitHub Releases: **__RELEASES_SIZE__** медыяфайлаў — па-за git, таму не ўлічваецца ў ліміце.",
...
const DE_ABOUT: About = About {
    ...
    build_log: "Build-Log",
    releases_size: "In GitHub Releases: **__RELEASES_SIZE__** Mediendateien — außerhalb von Git, zählt daher nicht zum Limit.",
...
const FR_ABOUT: About = About {
    ...
    releases_size: "Dans GitHub Releases : **__RELEASES_SIZE__** de fichiers multimédias — hors git, donc non compté dans la limite.",
...
const ZH_ABOUT: About = About {
    ...
    last_updated: "最后更新",
    build_log: "构建日志",
    releases_size: "在 GitHub Releases 中：**__RELEASES_SIZE__** 媒体文件 — 位于 git 之外，因此不计入限额。",
    wd_property: "属性",
    wd_value: "值",
...
const JA_ABOUT: About = About {
    ...
    last_updated: "最終更新",
    build_log: "ビルドログ",
    releases_size: "GitHub Releases 内: **__RELEASES_SIZE__** のメディアファイル — git の外にあるため、上限には含まれません。",
    wd_property: "プロパティ",
    wd_value: "値",
...
const PL_ABOUT: About = About {
    ...
    releases_size: "W GitHub Releases: **__RELEASES_SIZE__** plików multimedialnych — poza git, więc nie liczy się do limitu.",
...
const ES_ABOUT: About = About {
    ...
    releases_size: "En GitHub Releases: **__RELEASES_SIZE__** de archivos multimedia — fuera de git, por lo que no cuenta para el límite.",
...
const KO_ABOUT: About = About {
    ...
    build_log: "빌드 로그",
    releases_size: "GitHub Releases: **__RELEASES_SIZE__** 미디어 파일 — git 외부에 있어 한도에 포함되지 않습니다.",
    wd_property: "속성",
    wd_value: "값",
...
const KA_ABOUT: About = About {
    ...
    releases_size: "GitHub Releases-ში: **__RELEASES_SIZE__** მედია ფაილები — git-ის გარეთ, ამიტომ არ ითვლება ლიმიტში.",
    wd_property: "თვისება",
...
const HI_ABOUT: About = About {
    ...
    build_log: "बिल्ड लॉग",
    releases_size: "GitHub Releases में: **__RELEASES_SIZE__** मीडिया फ़ाइलें — git के बाहर, इसलिए सीमा में नहीं गिना जाता।",
    wd_property: "गुण",
    wd_value: "मान",
