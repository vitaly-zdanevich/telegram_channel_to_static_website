...
pub struct Ui {
    ...
    /// Heading for the related-posts list under a post.
...
pub struct About {
    ...
    /// "Last updated" label; followed by the build timestamp (`__LAST_BUILD__`).
    pub last_updated: &'static str,
    /// Link text for the CI job that produced the build.
    pub build_log: &'static str,
    /// Has `__RELEASES_SIZE__`; shown only when video is offloaded to Releases.
    pub releases_size: &'static str,
    /// Header for the property column of the optional Wikidata table.
    pub wd_property: &'static str,
    /// Header for the value column of the optional Wikidata table.
    pub wd_value: &'static str,
...
const EN_ABOUT: About = About {
    ...
    size_limit: "In the git repository: **__TOTAL_SIZE__** — **__PERCENT__** of the {limit_link}.",
    ...
    build_log: "build log",
    releases_size: "In GitHub Releases: **__RELEASES_SIZE__** of video and `.tar.xz` files — outside git, so it doesn't count toward the limit.",
    wd_property: "Property",
    wd_value: "Value",
...
const RU_ABOUT: About = About {
    ...
    size_limit: "В git-репозитории: **__TOTAL_SIZE__** — **__PERCENT__** от {limit_link}.",
    ...
    releases_size: "В GitHub Releases: **__RELEASES_SIZE__** видео и файлов `.tar.xz` — вне git, поэтому не учитывается в лимите.",
    wd_property: "Свойство",
    wd_value: "Значение",
...
const UK_ABOUT: About = About {
    ...
    size_limit: "У git-репозиторії: **__TOTAL_SIZE__** — **__PERCENT__** від {limit_link}.",
    ...
    build_log: "журнал збірки",
    releases_size: "У GitHub Releases: **__RELEASES_SIZE__** відео та файлів `.tar.xz` — поза git, тому не враховується в ліміті.",
    wd_property: "Властивість",
    wd_value: "Значення",
...
const BE_ABOUT: About = About {
    ...
    size_limit: "У git-рэпазіторыі: **__TOTAL_SIZE__** — **__PERCENT__** ад {limit_link}.",
    size_plain: "Сайт займае **__TOTAL_SIZE__** на дыску.",
    limit_phrase: "ліміту {name} у {display}",
    by_kind: "Па тыпах:",
    largest_files: "Найбуйнейшыя файлы:",
    generated_in: "Згенеравана за **__BUILD_TIME__**.",
    last_updated: "Абноўлена",
    build_log: "журнал зборкі",
    releases_size: "У GitHub Releases: **__RELEASES_SIZE__** відэа і файлаў `.tar.xz` — па-за git, таму не ўлічваецца ў ліміце.",
    wd_property: "Уласцівасць",
    wd_value: "Значэнне",
...
const DE_ABOUT: About = About {
    ...
    size_limit: "Im Git-Repository: **__TOTAL_SIZE__** — **__PERCENT__** des {limit_link}.",
    ...
    build_log: "Build-Log",
    releases_size: "In GitHub Releases: **__RELEASES_SIZE__** Video- und `.tar.xz`-Dateien — außerhalb von Git, zählt daher nicht zum Limit.",
    wd_property: "Eigenschaft",
    wd_value: "Wert",
...
const FR_ABOUT: About = About {
    ...
    size_limit: "Dans le dépôt git : **__TOTAL_SIZE__** — **__PERCENT__** de la {limit_link}.",
    ...
    build_log: "journal de build",
    releases_size: "Dans GitHub Releases : **__RELEASES_SIZE__** de vidéos et fichiers `.tar.xz` — hors git, donc non compté dans la limite.",
    wd_property: "Propriété",
    wd_value: "Valeur",
...
const ZH_ABOUT: About = About {
    ...
    size_limit: "在 git 仓库中：**__TOTAL_SIZE__**，为 {limit_link} 的 **__PERCENT__**。",
    ...
    last_updated: "最后更新",
    build_log: "构建日志",
    releases_size: "在 GitHub Releases 中：**__RELEASES_SIZE__** 视频和 `.tar.xz` 文件 — 位于 git 之外，因此不计入限额。",
    wd_property: "属性",
    wd_value: "值",
...
const JA_ABOUT: About = About {
    ...
    size_limit: "gitリポジトリ内: **__TOTAL_SIZE__** — {limit_link}の **__PERCENT__** です。",
    ...
    last_updated: "最終更新",
    build_log: "ビルドログ",
    releases_size: "GitHub Releases 内: **__RELEASES_SIZE__** の動画と `.tar.xz` ファイル — git の外にあるため、上限には含まれません。",
    wd_property: "プロパティ",
    wd_value: "値",
...
const PL_ABOUT: About = About {
    ...
    size_limit: "W repozytorium git: **__TOTAL_SIZE__** — **__PERCENT__** {limit_link}.",
    ...
    build_log: "dziennik kompilacji",
    releases_size: "W GitHub Releases: **__RELEASES_SIZE__** filmów i plików `.tar.xz` — poza git, więc nie liczy się do limitu.",
    wd_property: "Właściwość",
    wd_value: "Wartość",
...
const ES_ABOUT: About = About {
    ...
    size_limit: "En el repositorio git: **__TOTAL_SIZE__** — el **__PERCENT__** del {limit_link}.",
    ...
    build_log: "registro de compilación",
    releases_size: "En GitHub Releases: **__RELEASES_SIZE__** de vídeo y archivos `.tar.xz` — fuera de git, por lo que no cuenta para el límite.",
    wd_property: "Propiedad",
    wd_value: "Valor",
...
const KO_ABOUT: About = About {
    ...
    size_limit: "git 저장소: **__TOTAL_SIZE__** — {limit_link}의 **__PERCENT__**입니다.",
    ...
    build_log: "빌드 로그",
    releases_size: "GitHub Releases: **__RELEASES_SIZE__** 동영상 및 `.tar.xz` 파일 — git 외부에 있어 한도에 포함되지 않습니다.",
    wd_property: "속성",
    wd_value: "값",
...
const KA_ABOUT: About = About {
    ...
    size_limit: "git საცავში: **__TOTAL_SIZE__** ({limit_link}: **__PERCENT__**).",
    ...
    build_log: "აგების ჟურნალი",
    releases_size: "GitHub Releases-ში: **__RELEASES_SIZE__** ვიდეო და `.tar.xz` ფაილები — git-ის გარეთ, ამიტომ არ ითვლება ლიმიტში.",
    wd_property: "თვისება",
    wd_value: "მნიშვნელობა",
...
const HI_ABOUT: About = About {
    ...
    size_limit: "git रिपॉज़िटरी में: **__TOTAL_SIZE__** — {limit_link} का **__PERCENT__**।",
    ...
    build_log: "बिल्ड लॉग",
    releases_size: "GitHub Releases में: **__RELEASES_SIZE__** वीडियो और `.tar.xz` फ़ाइलें — git के बाहर, इसलिए सीमा में नहीं गिना जाता।",
    wd_property: "गुण",
    wd_value: "मान",
