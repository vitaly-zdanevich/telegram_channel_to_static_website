+++
title = "My new great bash alias (actually a hotkey) for faster cd"
...
next_id = 1683
next_title = "...and another useful bash alias to remove the text inside single quotes by esc-k"
prev_id = 1681
prev_title = "google found a quote that exists on youtube only"
views = 17
ids = [1682]
+++
