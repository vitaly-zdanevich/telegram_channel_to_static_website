...
| `REACTIONS` | `--no-reactions` | on | show per-emoji reaction counts (👍 42 · ❤️ 10). **Requires the [MTProto backend](#optional-mtproto-backend)** — `t.me/s/` never exposes reactions. `false` hides them |
