...
में ऑडियो भी लाता है (और `MTPROTO_IMAGES=1` होने पर वेब फ़ोटो को originals से बदल देता है):
...
- **रिएक्शन/लाइक उजागर नहीं होते** `t.me/s/` से। हम इसके बजाय **व्यू काउंट** निर्यात
  ...
  यदि आप कभी चाहें।
- **बड़े वीडियो डाउनलोड करने योग्य नहीं** — प्रीव्यू उनके लिए केवल एक पोस्टर छवि और अवधि
  देता है (छोटे/auto-play वीडियो *डाउनलोड करने योग्य* हैं)। असली फ़ाइल संग्रहीत करने के
  लिए भी MTProto API की ज़रूरत होगी।
