...
**3. जनरेट करें** क्रेडेंशियल परिवेश में रखते हुए — एक सामान्य रन ऑडियो,
मूल-गुणवत्ता की फ़ोटो और वे पूरे वीडियो भी संग्रहित करता है जिन्हें प्रीव्यू केवल
पोस्टर के रूप में दिखाता है। GitHub-आधारित साइटें मूल फ़ोटो Releases में रखती हैं:
...
| `MTPROTO_IMAGES` | मूल-गुणवत्ता की फ़ोटो लाता है; **डिफ़ॉल्ट रूप से चालू**, बंद करने के लिए `false`/`0` सेट करें। GitHub Releases चालू होने पर पुष्टि किए गए मूल चित्रों को हर बार फिर डाउनलोड करने के बजाय image releases से दोबारा उपयोग किया जाता है; बड़ा ऐतिहासिक backfill हर run में अधिकतम 500 नए मूल चित्र जोड़ता है |
